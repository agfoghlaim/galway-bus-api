...
// Gets all routes if stop is on more than one.
router.get(
	'/gstoptimes/:stopid',
...
router.get(
	'/bytripid/:tripid',
	wrapErrorHandler(realTimeController.getRTByTripId)
);

router.get(
	'/bytripidmatch/:tripid',
	wrapErrorHandler(realTimeController.handleGetRTByTripIdMatch)
);
